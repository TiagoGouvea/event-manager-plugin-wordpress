...
class ListTableInscritos extends WP_List_Table2
{
...
function ListTableInscritos($evento, $items, $subTitulo, $filter, $headerEvento = true)
{
    ...
    <div class="wrap">
        ...
        ?>
        <a href='admin-ajax.php?page=Inscricoes&action=exportarCsv&id_evento=<?php echo $evento->id; ?>&filter=<?php echo $filter; ?>&nonce=<?php echo $nonce; ?>' class='add-new-h2'>Exportar CSV</a>

        <?php if (TGO_EVENTO_FULLCONTACTS===true): ?>
            <a href='admin-ajax.php?page=Inscricoes&action=exportarCsvFullContacts&id_evento=<?php echo $evento->id; ?>&filter=<?php echo $filter; ?>&nonce=<?php echo $nonce; ?>' class='add-new-h2'>Exportar CSV Full Contacts</a>
        <?php endif; ?>

        <!--        --><?php //if ($filter=='naoConfirmados'):
        ?>
        <!--            <a href='admin.php?page=Inscricoes&action=cancelarNaoConfirmados&id_evento=--><?php //echo $evento->id;
